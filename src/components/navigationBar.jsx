    ...
    return (
      <div>
        <div className="header container-fluid">
          <div className=" header-title bg-info text-white text-center p-2 w3-black w3-center w3-allerta">
            <h4 className="w3-xxxlarge">Gary Trucking LLC</h4>
          </div>
        </div>
        <Navbar bg="light" expand="lg" className="justify-content-between">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto ">
              <NavDropdown title="Services" id="basic-nav-dropdown" className="pl-5">
              ...
              <NavDropdown title="Current Driver" id="basic-nav-dropdown" className="pl-5">
              ...
              <NavDropdown title="Future Driver" id="basic-nav-dropdown" className="pl-5">
